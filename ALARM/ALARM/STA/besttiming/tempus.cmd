...
#  Created on Mon Oct 13 10:56:16 2025                
#                                                     
#######################################################
...
report_constraints -all_violators > sta_besttiming/reports/allviolations.rpt
report_timing -delay_type min -max_paths 10000 > $report_dir/timing_report_hold.rpt
read_lib slow.lib
read_verilog synthesised_netlist.v
set_top_module alarm_mt251
