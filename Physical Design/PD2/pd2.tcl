...
floorPlan -site gsclib090site -r 1 0.8 4.8 4.8 4.8 4.8
...
reportGateCount -level 5 -limit 100 -outfile cts_reports/gates/gate_count.rpt
...
reportGateCount -level 5 -limit 100 -outfile post_route_reports/gates/gate_count.rpt


#/*Generating GDS*/
streamOut Digital_Clock_0_8.gds -mapFile streamOut.map -libName DesignLib -units 2000 -mode ALL
