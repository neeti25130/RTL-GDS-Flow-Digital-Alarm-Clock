...
create_clock -name "clk_pb34" -period 20.0 -waveform {0.0 10.0} [get_ports clk_pb34]
set_load -pin_load 0.05 [get_ports {d0_pb34[3]}]
set_load -pin_load 0.05 [get_ports {d0_pb34[2]}]
set_load -pin_load 0.05 [get_ports {d0_pb34[1]}]
set_load -pin_load 0.05 [get_ports {d0_pb34[0]}]
set_load -pin_load 0.05 [get_ports {d1_rp38[3]}]
set_load -pin_load 0.05 [get_ports {d1_rp38[2]}]
set_load -pin_load 0.05 [get_ports {d1_rp38[1]}]
set_load -pin_load 0.05 [get_ports {d1_rp38[0]}]
set_load -pin_load 0.05 [get_ports {d2_cs11[3]}]
set_load -pin_load 0.05 [get_ports {d2_cs11[2]}]
set_load -pin_load 0.05 [get_ports {d2_cs11[1]}]
set_load -pin_load 0.05 [get_ports {d2_cs11[0]}]
set_load -pin_load 0.05 [get_ports {d3_nm30[3]}]
set_load -pin_load 0.05 [get_ports {d3_nm30[2]}]
set_load -pin_load 0.05 [get_ports {d3_nm30[1]}]
set_load -pin_load 0.05 [get_ports {d3_nm30[0]}]
set_load -pin_load 0.05 [get_ports bz_pb34]
...
set_clock_uncertainty -setup 0.05 [get_clocks clk_pb34]
set_clock_uncertainty -hold 0.05 [get_clocks clk_pb34]
